...
<!----------------------------------------------------------------------HEADER------------------------------------------------------------------------->
    ...
    <div id="desc_whole">
            <div class="col-lg-5 col-md-5 col-sm-5" id="desc">
                <p id="heading"><span class="half-highlight"><b>N</b>OTES</span></p>
                <p id="about">Explore detailed notes and study materials from different institutions. <br>Access various learning content on university syllabi and coaching materials gathered from renowned universities across India for free!</p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6" id="illustration_one">
                <img src="img/Group%203479.svg" class="img-responsive" height="300" width="600" style="float: right; padding-left: 5%;">
            </div>
        ...
        <div class="row">
            <div class="form-group col-lg-4 col-md-5 col-sm-5">
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-6">
                 <img src="img/filter-filled-tool-symbol.svg" height="25" width="25" style="margin-top: 8px;">
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <b style="font-size: 18px;">Filters</b>
                </div>
        </div>
<!------------------------------------------------------------------------NOTES CONTENT------------------------------------------------------------------->
        <hr>
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 btn btn-primary" id="download">Download</div>
        </div>
        ...
        <div class="col-lg-1 col-md-2 col-sm-2 btn btn-primary" id="download">Download</div>
        </div>
        <hr>
    </div>
